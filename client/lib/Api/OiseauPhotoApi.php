...
/**
 * OiseauPhotoApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class OiseauPhotoApi
{
    ...
    /**
     * Operation postOiseauPhotoWithHttpInfo
     *
     * Creates a oiseauPhoto resource.
     *
     * @param \Swagger\Client\Model\OiseauPhoto $etape The new oiseauPhoto resource (optional)
    ...
    public function postOiseauPhotoWithHttpInfo($etape = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\OiseauPhoto',
                '/oiseauPhoto'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\OiseauPhoto', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\OiseauPhoto', $e->getResponseHeaders());
