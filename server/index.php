...
$app->GET('/adherents/{id}', function($request, $response, $args) {
            ...
            $adherent = new  \Models\Adherent();
            $adherent->setNom("denis");


            return $response->write(json_encode($adherent));
            
            /*$response->write('How about implementing getAdherent as a GET method ?');
            return $response;
            */
